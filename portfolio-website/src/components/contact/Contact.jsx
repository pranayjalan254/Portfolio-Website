...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_0bt6a4h", "template_hmjykf9", form.current, {
      publicKey: "dzPgnwsa_yDWbQ9tB",
    });
    e.target.reset();
  };
  return (
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              <MdOutlineMarkEmailRead className="contact__card-icon" />

              <h3 className="contact__card-title">Email</h3>
              <span className="contact__card-data">
                pranayjalan.work@gmail.com
              </span>
              <a
